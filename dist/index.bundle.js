...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "callDefault": () => (/* binding */ callDefault),
...
/* harmony export */   "getDisplayActivities": () => (/* binding */ getDisplayActivities),
/* harmony export */   "getPi": () => (/* binding */ getPi),
/* harmony export */   "getProjects": () => (/* binding */ getProjects),
/* harmony export */   "markActivityCompleted": () => (/* binding */ markActivityCompleted),
/* harmony export */   "markActivityIncompleted": () => (/* binding */ markActivityIncompleted),
/* harmony export */   "performanceAnalysis": () => (/* binding */ performanceAnalysis),
...
const moduleDomFunctions = (() => {
  ...
  const displayProjects = (projects) => {
    ...
    for (let i = 0; i < projects.length; i += 1) {
      ...
      const projectStat = _activity__WEBPACK_IMPORTED_MODULE_0__.stats.noOfActivitiesProject(projects[i]).length;
...
const getSortBy = (param) => {
  ...
  if ((0,_activity__WEBPACK_IMPORTED_MODULE_1__.getDisplayActivities)().length > 0) {
    if (param === 'title') {
      displayActivitiesSorted = (0,_activity__WEBPACK_IMPORTED_MODULE_1__.getDisplayActivities)().sort(_activity__WEBPACK_IMPORTED_MODULE_1__.sort.byTitle);
    } if (param === 'date') {
      displayActivitiesSorted = (0,_activity__WEBPACK_IMPORTED_MODULE_1__.getDisplayActivities)().sort(_activity__WEBPACK_IMPORTED_MODULE_1__.sort.byDate);
    } if (param === 'importance') {
      displayActivitiesSorted = (0,_activity__WEBPACK_IMPORTED_MODULE_1__.getDisplayActivities)().sort(_activity__WEBPACK_IMPORTED_MODULE_1__.sort.byImportance);
    }
  }
...
const displayAndActivators = (() => {
  const deleteButtonActivator = () => {
    ...
    for (let i = 0; i < deleteButtons.length; i += 1) {
      ...
      deleteButtons[i].addEventListener('click', (e) => {
        ...
        (0,_activity__WEBPACK_IMPORTED_MODULE_1__.removeActivity)(id);
    ...
    if (editButton !== null) {
      editButton.addEventListener('click', (e) => {
        ...
        if ((0,_validation__WEBPACK_IMPORTED_MODULE_3__.validCheckRequired)()) {
          (0,_activity__WEBPACK_IMPORTED_MODULE_1__.editActivity)(id);
          _domMan__WEBPACK_IMPORTED_MODULE_2__["default"].hideActivityWindow();
          _domMan__WEBPACK_IMPORTED_MODULE_2__["default"].resetForm();
          // eslint-disable-next-line no-use-before-define
          filterAndShow(currentFilter, `${filterHeader}`);
  ...
  const editButtonsActivator = () => {
    ...
    const activities = (0,_activity__WEBPACK_IMPORTED_MODULE_1__.getActivities)();
  ...
  const checkBoxActivator = () => {
    ...
    for (let i = 0; i < currentActivitiesCheck.length; i += 1) {
      currentActivitiesCheck[i].addEventListener('change', (e) => {
        ...
        if (e.target.checked) {
          (0,_activity__WEBPACK_IMPORTED_MODULE_1__.markActivityCompleted)(idData);
        } else if (!e.target.checked) {
          (0,_activity__WEBPACK_IMPORTED_MODULE_1__.markActivityIncompleted)(idData);
        }
        // eslint-disable-next-line no-use-before-define
        showActivities();
      });
  ...
  const displayPerformanceIndex = (activityArray) => {
    ...
    const piRate = _activity__WEBPACK_IMPORTED_MODULE_1__.performanceAnalysis.pi(activityArray);
    pi.innerHTML = `${piRate}`;
    const ipi = document.querySelector('.performance-info-container .ipi .result');
    const ipiRate = _activity__WEBPACK_IMPORTED_MODULE_1__.performanceAnalysis.ipi(activityArray);
    ipi.innerHTML = `${ipiRate}`;
  };

  const displayStats = () => {
    const todayStat = document.querySelector('button.today span.stat');
    todayStat.innerHTML = `${_activity__WEBPACK_IMPORTED_MODULE_1__.stats.noOfActivitiesToday()}`;

    const thisWeekStat = document.querySelector('button.this-week span.stat');
    thisWeekStat.innerHTML = `${_activity__WEBPACK_IMPORTED_MODULE_1__.stats.noOfActivitiesThisWeek()}`;

    const allActivitiesStat = document.querySelector('button.all-activities span.stat');
    allActivitiesStat.innerHTML = `${_activity__WEBPACK_IMPORTED_MODULE_1__.stats.noOfActivitiesAll()}`;
  };
  ...
  function showActivities() {
    ...
    const projects = (0,_activity__WEBPACK_IMPORTED_MODULE_1__.getProjects)();
    ...
    displayStats();
    console.log((0,_activity__WEBPACK_IMPORTED_MODULE_1__.getActivities)());
    return true;
  }
...
function save() {
  if ((0,_validation__WEBPACK_IMPORTED_MODULE_3__.validCheckRequired)() && (0,_validation__WEBPACK_IMPORTED_MODULE_3__.validCheckExist)()) {
    ...
    (0,_activity__WEBPACK_IMPORTED_MODULE_1__.saveActivity)();
...
logo.addEventListener('click', () => {
  (0,_activity__WEBPACK_IMPORTED_MODULE_1__.callDefault)();
  filterAndShow(currentFilter, `${filterHeader}`);
});
