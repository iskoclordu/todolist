...
let displayActivitiesSorted = (0,_activity__WEBPACK_IMPORTED_MODULE_1__.getDisplayActivities)().sort(_activity__WEBPACK_IMPORTED_MODULE_1__.sort.byDate);
let parameter = 'date';
...
cancelButton.addEventListener('click', () => {
  (0,_domMan__WEBPACK_IMPORTED_MODULE_2__.callresetForm)();
  saveButtonActivator();
});
...
const deleteButtonActivator = () => {
  ...
  for (let i = 0; i < deleteButtons.length; i += 1) {
    ...
    deleteButtons[i].addEventListener('click', (e) => {
      ...
      (0,_activity__WEBPACK_IMPORTED_MODULE_1__.removeActivity)(indexNumber);
      // eslint-disable-next-line no-use-before-define
  ...
  if (deleteButton !== null) {
    deleteButton.addEventListener('click', (e) => {
      ...
      (0,_domMan__WEBPACK_IMPORTED_MODULE_2__.callhidePopup)();
      saveButtonActivator();
    });
  }
};
...
const editButtonActivator = () => {
  ...
  if (editButton !== null) {
    editButton.addEventListener('click', (e) => {
      ...
      if ((0,_validation__WEBPACK_IMPORTED_MODULE_3__["default"])()) {
        (0,_activity__WEBPACK_IMPORTED_MODULE_1__.editActivity)(indexNumber);
        (0,_domMan__WEBPACK_IMPORTED_MODULE_2__.callhidePopup)();
        (0,_domMan__WEBPACK_IMPORTED_MODULE_2__.callresetForm)();
        // eslint-disable-next-line no-use-before-define
        filterAndShow(currentFilter);
...
function showActivities() {
  ...
  for (let i = 0; i < displayActivities.length; i += 1) {
    if (displayActivities[i] !== undefined) {
      (0,_domMan__WEBPACK_IMPORTED_MODULE_2__.callCreateActivityDiv)(displayActivities, i, '.todos');
    }
  }

  const projects = (0,_activity__WEBPACK_IMPORTED_MODULE_1__.getProjects)();
  if (projects.length > 0) {
    (0,_domMan__WEBPACK_IMPORTED_MODULE_2__.callDisplayProjects)(projects);
  }
  ...
  if (displayActivities.length > 0) {
    ...
    for (let i = 0; i < currentActivities.length; i += 1) {
      ...
      currentActivities[i].addEventListener('click', (e) => {
        ...
        (0,_domMan__WEBPACK_IMPORTED_MODULE_2__.callDisplayActivityReadOnly)(activities, idData);
        deleteButtonActivator();
      });
    }
    ...
    for (let i = 0; i < editButtons.length; i += 1) {
      ...
      editButtons[i].addEventListener('click', (e) => {
        ...
        (0,_domMan__WEBPACK_IMPORTED_MODULE_2__.callDisplayActivityEditable)(activities, indexNumber);
        editButtonActivator();
        deleteButtonActivator();
      });
    }
    ...
    const piRate = _activity__WEBPACK_IMPORTED_MODULE_1__.performanceAnalysis.pi(displayActivities);
    pi.innerHTML = `${piRate}`;
    const ipi = document.querySelector('.performance-info-container .ipi .result');
    const ipiRate = _activity__WEBPACK_IMPORTED_MODULE_1__.performanceAnalysis.ipi(displayActivities);
