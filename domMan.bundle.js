...
const moduleData = (() => {
  const getData = () => {
    ...
    const date = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(new Date(dateRaw), 'MM/dd/yyyy');
...
const moduleFilter = (() => {
  ...
  const filterActivitiesToday = () => activities.filter((obj) => obj.activity.date === (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(new Date(), 'MM/dd/yyy'));

  const filterActivitiesThisWeek = () => {
    const today = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(new Date(), 'MM/dd/yyyy');
    const nextWeek = new Date();
    nextWeek.setDate(nextWeek.getDate() + 7);
    const nextWeekFormatted = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(new Date(nextWeek), 'MM/dd/yyyy');
...
const sort = (() => {
  ...
  const byDate = (el1, el2) => {
    const act1Date = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(new Date(el1.activity.date), 'MM/dd/yyyy');
    const act2Date = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(new Date(el2.activity.date), 'MM/dd/yyyy');
